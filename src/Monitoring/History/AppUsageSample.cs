...
/// is a wire-shaped series id: "cpu", "memory", "storage", "net",
/// "gpu:&lt;gid&gt;", or "vram:&lt;gid&gt;" (gid already
/// MetricsHistory.SanitizeId-ed, matching the scalar gpu series convention
/// so a metric id round-trips between the scalar and per-app tables). Apps
/// is already trimmed to the top-N by value.</summary>
