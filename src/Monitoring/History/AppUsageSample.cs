...
/// "storage-read", "storage-write", "net-down", "net-up", "gpu:&lt;gid&gt;",
/// or "vram:&lt;gid&gt;" (gid already MetricsHistory.SanitizeId-ed, matching
/// the scalar gpu series convention so a metric id round-trips between the
