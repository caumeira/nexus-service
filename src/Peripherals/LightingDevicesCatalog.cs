...
public static class LightingDevicesCatalog
{
    ...
    private static readonly IReadOnlyList<SupportedDeviceDto> FirstPartyDevices = new List<SupportedDeviceDto>
    {
        ...
        // Galahad II LCD also exposes a twelve-position pump RGB interface; the other LCD
        // rows remain screen-only until their lighting protocols are verified.
        Native("Lian Li",    "Galahad II LCD",      "aio",      "0x0416", "0x7395", screen: true),
