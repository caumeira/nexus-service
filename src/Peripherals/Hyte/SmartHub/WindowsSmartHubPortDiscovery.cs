...
/// <summary>
/// SetupAPI-based discovery for HYTE Smart Hubs on Windows. Mirrors
/// <c>WindowsMiniHubPortDiscovery</c> / <c>WindowsNp50PortDiscovery</c>
/// verbatim except for the VID/PID fragment. Returns the same
/// <see cref="Np50PortInfo"/> shape (port name + serial) so the hub stack
/// stays generic over which device it's talking to.
/// </summary>
public sealed class WindowsSmartHubPortDiscovery : INp50PortDiscovery
{
    private static readonly Guid PortsClassGuid = new("4d36e978-e325-11ce-bfc1-08002be10318");
    private static readonly string VidPidFragment = $"VID_{SmartHubProtocol.VendorId:X4}&PID_{SmartHubProtocol.ProductId:X4}";
