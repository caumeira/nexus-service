...
builder.Services.AddNexusMonitoringHistory();
Nexus.Service.Lifecycle.BootTimer.Mark("DI: AddNexusMonitoringHistory");
...
builder.Services.AddNexusFps();
Nexus.Service.Lifecycle.BootTimer.Mark("DI: AddNexusFps");
...
// Local assistant (Ollama download + model pulls): dev-tools builds only.
#if DEV_TOOLS
...
app.MapFanControlMigrationEndpoints();
