...
// Outbound stream camera clients capture from.
class NexusCameraStreamSource: NSObject, CMIOExtensionStreamSource {
    ...
    var activeFormatIndex = 0 {
        didSet {
            if activeFormatIndex >= 1 {
                os_log(.error, log: nexusCameraLog, "invalid source format index")
            }
        }
    }
