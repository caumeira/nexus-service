...
- **Peripherals** - first-party USB device drivers (HYTE Keeb/CNVS/hubs, the Lian Li Uni fan family, Galahad II AIO, Strimer, Corsair iCUE LINK and Xeneon Edge, iBUYPOWER AW5, Tryx, Q-Series, Y70) plus the curated supported-hardware catalogs behind `/peripherals/supported` and `/peripherals/all-supported` (`Peripherals/`).
