...
public class NexusServiceCollectionExtensionsTests
{
    ...
    public void Devices_resolves_manager_and_handlers()
    {
        ...
        // CNVS, QSeries (Q60+Q80 collapsed), Y70, Keeb, FanHub, NP50, SmartHub, LianLi, LianLiWireless, LianLiTl, Galahad2, CorsairLink, Strimer, Tryx, StreamDeck
        Assert.Equal(15, handlers.Length);
    }
