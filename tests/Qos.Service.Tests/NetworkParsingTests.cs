...
public class NetworkParsingTests
{
    ...
    public void StripPidSuffix_RemovesPidFromProcessName()
    {
        ...
        Assert.Equal("qos-service", StripPid("qos-service.999"));
    }
    ...
    {
        // qos-service (PID 9876) only talks to localhost.
        ...
        Assert.DoesNotContain(9876, pids); // qos-service is loopback-only
