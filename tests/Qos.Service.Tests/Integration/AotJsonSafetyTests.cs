...
using Qos.Service.Activity; // ProcessFrame, NetworkFrame, ScreenTimeFrame
...
public class AotJsonSafetyTests
{
    ...
    public void EveryResponseTypeInModels_IsRegistered()
    {
        ...
        // `public class *Frame` under Qos.Service.Models.* and assert
        ...
        {
            if (t.Namespace is null || !t.Namespace.StartsWith("Qos.Service.Models", StringComparison.Ordinal))
                continue;
